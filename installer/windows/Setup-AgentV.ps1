param([string]$ExePath = "$PSScriptRoot\AgentV.exe", [string]$Server = "https://sd.vishalojha.me")
$ErrorActionPreference = "Stop"
Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName Microsoft.VisualBasic
$app = Join-Path $env:APPDATA "AgentV"
New-Item -ItemType Directory -Force -Path $app | Out-Null
Copy-Item $ExePath (Join-Path $app "AgentV.exe") -Force
...
$action = New-ScheduledTaskAction -Execute (Join-Path $app "AgentV.exe") -WorkingDirectory $app
